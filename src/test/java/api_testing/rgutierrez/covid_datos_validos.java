...
public class covid_datos_validos {
    ...
    {
        File file = new File("src/test/java/api_testing/rgutierrez/covid-schema.json");
    ...
    @Test
    public void ATC03_retorna_pais_correspondiente()
    {
        String country = given().header("x-rapidapi-key",this.key).
                            and().header("x-rapidapi-host",this.host).
                            param("name",this.name).
                            param("date", this.date).
                            when().
