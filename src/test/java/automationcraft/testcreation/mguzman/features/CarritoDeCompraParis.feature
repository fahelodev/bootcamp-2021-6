Feature: Carrito de Compra
  ...
  Background: Agregar producto
    Given que estoy url "https://www.paris.cl/iphone-11-64gb-negro%C2%A0%C2%A0-486146999.html#q=iphone&start=1"
    When presiono el boton añadir al carro
    Then se debe agregar correctamente el producto al carrito.

  Scenario Outline: CA-01 - Límite de Stock de un producto
