package automationcraft.testcreation.ncorrea.steps;

import automationcraft.engine.selenium.DriverFactory;
import automationcraft.testcreation.ncorrea.pages.CarroDeCompraParisPage;
import io.cucumber.java.en.Given;
import io.cucumber.java.en.Then;
import io.cucumber.java.en.When;

public class CarroDeCompraParisSteps {

    CarroDeCompraParisPage carroDeCompraParisPage = new CarroDeCompraParisPage(DriverFactory.getDriver());

    @Given("que estoy en la url {string}")
    public void que_estoy_en_la_url (String string)throws Exception {
        carroDeCompraParisPage.validacionUrl(string);
    }

    @When("presiono el boton añadir al carro")
    public void presiono_el_boton_añadir_al_carro() {
            carroDeCompraParisPage.añadirAlCarrito();
    ...
    public void se_debe_agregar_correctamente_el_producto_al_carrito(){
        carroDeCompraParisPage.validacionProducto();
        carroDeCompraParisPage.irAlCarro();
        }
    ...
    public void que_el_cliente_está_el_en_carrito_de_compras_con_producto(Integer int1) {
        carroDeCompraParisPage.cantidadProductos(int1);
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void el_cliente_aumenta_la_cantidad_a_pedir_del_producto_haciendo_click_en_el_botón_del_producto_a_un_número_mayor_de(Integer int1) {
