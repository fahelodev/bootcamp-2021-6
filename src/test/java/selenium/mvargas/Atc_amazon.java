...
public class Atc_amazon {
    ...
    public void init(){
        ...
        driver.get("https://www.amazon.com/"); //Cargar la páginas

    }

    @Test
    public void atc_Amazon() throws InterruptedException {


        driver.findElement(By.cssSelector("i.hm-icon")).click();//Hacer click en campo SEARCH

       //Select objSelect = new Select(driver.findElement(By.cssSelector("select.nav-search-dropdown")));
       //objSelect.selectByValue("search-alias=electronics-intl-ship");

         Thread.sleep(3000); //no usar sleep
         driver.findElement(By.id("nav-search-label-id")).click();
