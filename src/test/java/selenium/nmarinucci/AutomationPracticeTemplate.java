...
public class AutomationPracticeTemplate {
    ...
    public void atc03MensajeProductoNoEncontrado(){
        ...
        driver.get("http://automationpractice.com/");
        driver.findElement(By.xpath("//input[@id='search_query_top']")).sendKeys( "liquido matapulgas");
        driver.findElement(By.xpath("//button[@name='submit_search']")).click();
    ...
    @Test
    public void act04EncontrarProductoDeListaDinamica() throws InterruptedException {
